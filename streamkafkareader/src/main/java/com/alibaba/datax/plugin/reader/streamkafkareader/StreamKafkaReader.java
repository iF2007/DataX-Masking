package com.alibaba.datax.plugin.reader.streamkafkareader;
...
import com.alibaba.datax.plugin.reader.streamkafkareader.Constant;
import com.alibaba.datax.plugin.reader.streamkafkareader.Key;
import com.alibaba.datax.plugin.reader.streamkafkareader.StreamKafkaReaderErrorCode;
...
public class StreamKafkaReader extends Reader {
				...
				while (true) {
					...
					for (ConsumerRecord<String, String> kafkarecord : kafkaRecords) {
						...
						try {
							...
							throw DataXException.asDataXException(StreamKafkaReaderErrorCode.ILLEGAL_VALUE,
									"构造一个record失败.", e);
						}
